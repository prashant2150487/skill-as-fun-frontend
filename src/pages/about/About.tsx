        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
            <div className="space-y-4 bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-blue-100 dark:bg-gray-800/80 dark:border-gray-700 transform transition-transform hover:scale-[1.02]">
              ...
              <p className="text-gray-600 dark:text-gray-300 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                We are committed to creating tools that support educators, empower students, and transform the
                educational experience. By combining pedagogical expertise with technological innovation, we aim to
                address the unique challenges facing education today and prepare learners for the demands of tomorrow.
              </p>
            </div>
            <div className="space-y-4 bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-pink-100 dark:bg-gray-800/80 dark:border-gray-700 transform transition-transform hover:scale-[1.02]">
              ...
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight bg-clip-text text-transparent bg-gradient-to-r from-pink-600 to-rose-600">
                A world where technology enhances human potential through education
              </h2>
              <p className="text-gray-600 dark:text-gray-300 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                We envision a future where educational technology seamlessly integrates into learning environments,
                enhancing rather than replacing human connection. Our vision is to lead the transformation of education
                through thoughtful innovation that respects the essential role of teachers while expanding what's
                possible in education.
              </p>
              <p className="text-gray-600 dark:text-gray-300 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                We see a world where personalized learning experiences are the norm, where data-driven insights help
                educators make informed decisions, and where technology bridges gaps in educational access and quality.
                Through our work, we strive to make this vision a reality, one classroom, one school, and one
        ...
        <div className="container px-4 md:px-6 relative z-10 mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="inline-flex items-center justify-center p-2 bg-blue-100 dark:bg-blue-900/30 backdrop-blur-sm rounded-full mb-4">
              ...
              <span className="text-sm font-medium text-blue-700 dark:text-blue-300">Our Journey</span>
            </div>
            <div className="space-y-2">
        ...
        <div className="container px-4 md:px-6 relative z-10 mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="inline-flex items-center justify-center p-2 bg-purple-100 dark:bg-purple-900/30 backdrop-blur-sm rounded-full mb-4">
              ...
              <span className="text-sm font-medium text-purple-700 dark:text-purple-300">What Drives Us</span>
            </div>
            <div className="space-y-2">
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="space-y-6">
              <div className="inline-flex items-center justify-center p-2 bg-white/10 backdrop-blur-sm rounded-full">
                ...
                <span className="text-sm font-medium text-blue-100">Our Approach</span>
              </div>
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="inline-flex items-center justify-center p-2 bg-amber-100 dark:bg-amber-900/30 backdrop-blur-sm rounded-full mb-4">
              ...
              <span className="text-sm font-medium text-amber-700 dark:text-amber-300">Recognition of Excellence</span>
            </div>
            <div className="space-y-2">
            ...
            {[
              ...
              >
                ...
                <div className="flex items-center space-x-3">
                  <div className={`p-2 rounded-full bg-gradient-to-r ${achievement.gradient} text-white`}>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              { number: "500+", text: "Educational institutions using our products" },
              { number: "28", text: "Countries where our solutions are implemented" },
              { number: "5M+", text: "Students benefiting from our technology" },
              { number: "120", text: "Team members passionate about education" },
            ].map((stat, index) => (
              <div
                key={index}
              ...
              >
                ...
                <p className="text-center text-sm text-gray-600 dark:text-gray-300">{stat.text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="inline-flex items-center justify-center p-2 bg-emerald-100 dark:bg-emerald-900/30 backdrop-blur-sm rounded-full mb-4">
              ...
              <span className="text-sm font-medium text-emerald-700 dark:text-emerald-300">Voices of Success</span>
            </div>
            <div className="space-y-2">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="inline-flex items-center justify-center p-2 bg-violet-100 dark:bg-violet-900/30 backdrop-blur-sm rounded-full mb-4">
              ...
              <span className="text-sm font-medium text-violet-700 dark:text-violet-300">Collaborative Excellence</span>
            </div>
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-violet-700 dark:text-violet-300 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Organizations we collaborate with to advance educational technology
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 flex flex-col items-center justify-center space-y-4 text-center">
            <p className="mx-auto max-w-[700px] text-violet-700 dark:text-violet-300">
              We're proud to work with leading educational institutions, research organizations, and technology
              companies to push the boundaries of what's possible in educational technology.
            </p>
            <Button
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
            <div className="space-y-6">
              ...
              <p className="text-gray-600 dark:text-gray-300 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                We'd love to hear from you and discuss how our educational technology solutions can address your
                ...
                {[
                  {
                    ...
                    title: "Headquarters",
                    details: "123 Innovation Way, Suite 400\nSan Francisco, CA 94103",
                  ...
                  },
                  {
                    ...
                    details: "New York • Chicago • Austin • London • Singapore • Sydney",
                    gradient: "from-amber-500 to-orange-500",
                  },
                ].map((contact, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    <div className={`p-2 rounded-full bg-gradient-to-r ${contact.gradient} flex-shrink-0`}>
                      {contact.icon}
                    </div>
                    <div>
                      <h3 className="font-bold">{contact.title}</h3>
                      <p className="text-gray-600 dark:text-gray-300 whitespace-pre-line">{contact.details}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="relative bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg dark:bg-gray-800/90">
                ...
                <div className="grid gap-4">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <Link to="/privacy" className="underline underline-offset-2 text-blue-600 dark:text-blue-400">
                      Privacy Policy
                    </Link>
                    .
                  </p>
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="inline-flex items-center justify-center p-2 bg-white/10 backdrop-blur-sm rounded-full mb-4">
              ...
              <span className="text-sm font-medium text-blue-100">Join Our Community</span>
            </div>
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-blue-100 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Join hundreds of educational institutions that are already using our technology to improve learning
